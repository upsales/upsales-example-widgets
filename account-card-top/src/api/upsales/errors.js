module.exports = {
	...
	UPSALES_GET_SALES_ERROR: {
		code: 'UPSALES_GET_SALES_ERROR',
		message: 'Some error has occured while getting Upsales sales',
	},

	UPSALES_GET_AGREEMENT_ERROR: {
		code: 'UPSALES_GET_AGREEMENT_ERROR',
		message: 'Some error has occured while getting Upsales agreements',
	},

	UPSALES_GET_ACTIVITIES_ERROR: {
		code: 'UPSALES_GET_ACTIVITIES_ERROR',
		message: 'Some error has occured while getting Upsales activities',
	}
};
